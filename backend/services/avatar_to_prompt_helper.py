...
class AvatarToPromptHelper:
    ...
    @staticmethod
    def avatar_to_description(
        avatar_params: dict, age: int, context: str = None
    ) -> str:
        ...
        if "skinColor" in avatar_params:
            skin_tone = AvatarToPromptHelper._humanize_skin_color(
                avatar_params["skinColor"]
            )
        ...
        if "top" in avatar_params:
            ...
            hair_color = AvatarToPromptHelper._humanize_color(
                avatar_params.get("hairColor", "brown")
            )
        ...
        if "clothing" in avatar_params:
            clothing_item = AvatarToPromptHelper._humanize_clothing(
                avatar_params["clothing"]
            )
            color = AvatarToPromptHelper._humanize_color(
                avatar_params.get("clothesColor", "")
            )
            if color:
        ...
        if "accessories" in avatar_params and avatar_params["accessories"] != "blank":
            accessory = AvatarToPromptHelper._humanize_accessory(
                avatar_params["accessories"]
            )
            if accessory:
    ...
    @staticmethod
    def to_story_illustration_prompt(
        avatar_params: dict, age: int, scene: str, emotion: str
    ) -> str:
