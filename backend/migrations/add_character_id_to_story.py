...
def _run_sqlite():
    ...
    if not os.path.exists(db_path):
        ...
        alt_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'characters.db')
    ...
    try:
        ...
        cursor.execute("CREATE INDEX IF NOT EXISTS ix_story_character_id ON story(character_id)")
        conn.commit()
