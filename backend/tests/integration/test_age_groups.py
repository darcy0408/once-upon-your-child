...
class TestAgeGroupStoryGeneration:
    ...
    def test_age_16_generates_appropriate_word_count(self, client):
        ...
        assert 600 <= word_count <= 2100, f"Age 16 story has {word_count} words, expected 650-2000"
...
class TestVocabularyComplexity:
    ...
    def test_vocabulary_complexity_increases_with_age(self, client):
        ...
        test_cases = [
            ...
            (16, "The feline perched precariously upon the intricately woven tapestry. " * 30)
        ]
...
class TestAgeConstraintsCoverage:
    ...
    def test_age_constraints_have_word_count_ranges(self):
        ...
        for constraint_key, constraint_data in AGE_CONSTRAINTS.items():
            ...
            assert any(mode in constraint_data for mode in ['regular', 'rhyme', 'ltr']), \
            ...
            if 'regular' in constraint_data:
                ...
                for length in ['short', 'medium', 'long']:
                    if length in regular:
                        ...
                        assert isinstance(regular[length], tuple) and len(regular[length]) == 2, \
