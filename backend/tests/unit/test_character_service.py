...
class TestPetSanitization:
    ...
    def test_sanitize_pets_with_boolean_fields(self):
        ...
        pets_data = [
            {'name': 'Fluffy', 'species': 'cat', 'friendly': True}
        ]
    ...
    def test_sanitize_pets_filters_invalid_types(self):
        ...
        pets_data = [
            {'name': 'Fluffy', 'species': 'cat', 'invalid': ['list']}
        ]
...
class TestUpdateCharacter:
    ...
    def test_update_character_personality_sliders(self, mock_repository, mock_character):
