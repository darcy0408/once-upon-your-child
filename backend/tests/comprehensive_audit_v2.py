...
class TestStoryAuditVariations(unittest.TestCase):
    ...
    def test_gender_inclusion(self):
        ...
        try:
            self.verify_prompt_contains(
                prompt,
                ["Girl", "She/Her"],
                "Prompt should include explicit gender/pronouns if provided.",
            )
    ...
    def test_age_5_scary_theme_safety(self):
        ...
        self.verify_prompt_excludes(
            prompt, ["psychological tension", "clever plot twist"]
        )
    ...
    def test_age_15_scary_theme_maturity(self):
        ...
        self.verify_prompt_contains(
            prompt, ["Complex stakes", "clever plot twist", "moment of wonder"]
        )
    ...
    def test_interactive_ending_injection(self):
        ...
        self.verify_prompt_contains(
            prompt, ["ENDING LOGIC", "conclude the story", "segment 7/7"]  # 6+1 = 7
        )
