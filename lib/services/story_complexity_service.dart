...
class StoryComplexityService {
  static const List<AgeGroup> ageGroups = [
    ...
    AgeGroup(
      ...
      minWords: 900,
      maxWords: 2400,
      vocabularyLevel: 'Grade 3-4 vocabulary',
      exampleWords: ['beautiful', 'important', 'different', 'together', 'adventure', 'discover', 'wonderful', 'carefully'],
      complexityDescription: 'A full, substantial story with grade-appropriate vocabulary, a two-step challenge, and character growth',
    ),
    AgeGroup(
      name: 'Early Teen',
      minAge: 13,
