...
class WizardDataMapper {
  static Map<String, dynamic> mapToStoryRequest(WizardData data) {
    ...
    // reads char_details.get('pronouns') and interpolates it. The gender
    // picker only ever stores 'Boy' or 'Girl' (binary by design).
    ...
    for (final companionName in companionNames) {
      ...
      if (isPet) {
        ...
        final bandBehavior = companionBehaviorPatterns[bandKey] ??
            ...
            '';
        // R3 (Audit 14): forward the band-specific description for companions
