...
Once Upon YOUR Child (powered by Story Weaver) is committed to protecting the privacy and safety of children and families who use our storytelling platform. We believe that tools for children should be safe, transparent, and respectful of personal boundaries.
...
Once Upon YOUR Child is designed for children ages 3-17. We take special care with children's data:
...
Once Upon YOUR Child uses the third-party service providers below. We share only the minimum data required for each service to function. Each provider's own privacy policy governs its processing.
